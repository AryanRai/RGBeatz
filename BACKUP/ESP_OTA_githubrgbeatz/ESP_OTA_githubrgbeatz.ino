...
void setup() {
	...
	Serial.println("================================================================================");
	Serial.println("|                                                                              |");
	Serial.println("|                Welcome to the ESP GitHub OTA Updater BETA (FOR RGBEATZ)      |");
	Serial.println("|                =============================================                 |");
	Serial.println("|                                                                              |");
	Serial.println("|    Author:     ARYAN RAI                                                     |");
	Serial.println("|    Repository: https://github.com/AryanRai/RGBeatz_firmware_beta/            |");
	Serial.println("|    Version:    0.0.0                                                         |");
	Serial.println("|    Date:       14th November 2020                                            |");
	Serial.println("|                                                                              |");
	Serial.println("================================================================================");
	Serial.println();
	Serial.println();
